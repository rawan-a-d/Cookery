...
public class DataStore {
    ...
    private DataStore() {
        ...
        Recipe recipe2 = new Recipe("Stuffed zucchini (kousa mahshi)", "img.png", "Cut off the zucchini " +
                ...
                "Serve the stuffed zucchini with a little of the sauce and a dollop of yoghurt.", 2);
        ...
        Recipe recipe4 = new Recipe("Lasagna Flatbread\n", "img.png", "Step 1\n" +
                ...
                "\n" +
                " Step 5\n" +
                "Bake in the preheated oven until cheese is melted and bubbly, 10 to 15 minutes.", 1);
    ...
    public List<Recipe> getRecipesBy(Ingredient ingredient){
